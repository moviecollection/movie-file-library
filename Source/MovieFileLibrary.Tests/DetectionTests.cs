...
namespace MovieFileLibrary.Tests
{
    public class DetectionTests
    {
        ...
        [InlineData("Frasier.S09Ep15.1080p.mp4")]
        [InlineData("Frasier.S09EP16.1080p.mp4")]
        [InlineData("Frasier.S09.Ep17.1080p.mp4")]
        [InlineData("Frasier.S09.EP18.1080p.mp4")]
        [InlineData("Frasier.Se09E19.1080p.mp4")]
        [InlineData("Frasier.Se09.E20.1080p.mp4")]
        [InlineData("Frasier.Se09Ep21.1080p.mp4")]
        [InlineData("Frasier.Se09.Ep22.1080p.mp4")]
